...
public class SymbolTable {
    ...
    public SymbolTable(MemoryFacade memoryFacade) {
        this.memoryFacade = memoryFacade;
        klasses = new HashMap<>();
        keyWords = new HashMap<>();
        keyWords.put("true", new Address(1, varType.Bool, new ImmediateAddress()));
        keyWords.put("false", new Address(0, varType.Bool, new ImmediateAddress()));
    }
    ...
    public void addField(String fieldName, String className) {
        ...
        memoryFacade.incrementLastDateAddress();
    }
